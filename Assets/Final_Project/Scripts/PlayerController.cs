...
//    [SyncVar(hook = "OnPIDChange")]
//    public int pid;


//    void OnPIDChange(int id)
//    {
//        pid = id;
//        Debug.Log("Player id set on player " + pid);
...
public class PlayerController : NetworkBehaviour
{
    ...
    public override void OnStartServer()
    {
        ...
        while (gs == null)
        {
            ...
            if (temp != null)
                gs = temp.GetComponent<GameState>();
        }
    ...
    void CmdIncrPlayerId()
    {
        ...
        gs.AddNewPlayer();   // this increments lastPlayerId and adds an entry in the scoreboard array

        // Here I am letting the server send the new value via the syncvar
        playerId = gs.lastPlayerId;
