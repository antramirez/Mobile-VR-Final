...
namespace A08dkg3
{
    ...
    {
        // this script moves the enemies around the scene, having them shoot every 5 seconds
        // the direction they move is random and so is the rotation of them in the scene
